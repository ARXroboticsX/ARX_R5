...
namespace arx::r5
{
    R5Controller::R5Controller() : Node("l5_pro_controller_node")
    {
        ...
        // 创建发布器
        joint_state_publisher_ = this->create_publisher<arx_r5_msg::msg::RobotStatus>("r5_status", 1);
        // 创建订阅器
        joint_state_subscriber_ = this->create_subscription<arx_r5_msg::msg::RobotCmd>(
            "r5_cmd", 10, std::bind(&R5Controller::CmdCallback, this, std::placeholders::_1));
        // 定时器，用于发布关节信息
    ...
    void R5Controller::CmdCallback(const arx_r5_msg::msg::RobotCmd::SharedPtr msg)
    {
    ...
    void R5Controller::PubState()
    {
        ...
        auto message = arx_r5_msg::msg::RobotStatus();
