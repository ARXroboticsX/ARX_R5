...
# R5
gnome-terminal -t "R5" -x  bash -c "cd ${workspace};cd ROS2/R5_ws; source install/setup.bash && ros2 launch arx_r5_controller open_vr_single_arm.launch.py; exec bash;"
